 ...
 */
public class StickyRDialog extends RDialog implements WindowListener
{
   ...
   public StickyRDialog(String title, Component view, RBar bar,String ID,String key)
   {
      this(title,view,bar,ID,key,DEF_LOCATION, DEF_DIMENSION);
   }

   public StickyRDialog(Component view, String ID, String key, Point defaultLocation, Dimension defaultSize)
   {
      this(view.getName(), view, new RBar(false), ID,key,defaultLocation, defaultSize);
   }
   public StickyRDialog(String title, Component view, RBar bar, String ID,String key, Point defaultLocation, Dimension defaultSize)
	{
